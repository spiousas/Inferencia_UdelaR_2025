...
# Cosinor y sus formulitas

$$
Y(t) = M + Acos(\frac{2\pi t}{\tau} - \phi) + e(t)
$$
...
$$
\begin{array}
_ \hat\phi &=& \arctan(\frac{\hat\gamma}{\hat\beta}) \\
...
$$
\begin{array}
_\hat{Temp(t)} &=& \hat{M} + \hat{A}cos(\frac{2\pi t}{\tau} - \hat{\phi}) \\
\hat{Temp(t)} &=& 17.02 + 6.11 \times cos(\frac{2\pi t}{365.25} - 0.46) \\
\end{array}
$$