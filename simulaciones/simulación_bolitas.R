...
CIs_mu <- muestras %>% 
  ...
  summarise(mu_hat = mean(peso),
            mu_low = mu_hat - qnorm(.975)/sqrt(n_elegido) * 4,
            mu_high = mu_hat + qnorm(.975)/sqrt(n_elegido) * 4)
...
### n = 12 ####
set.seed(11)
muestra_12 <- c(12.7, 8.9, 14.1, 7.5, 14.5, 15, 16.6, 7.5, 10.9, 8.3, 12.3, 17.5)
